...
func Decfloat() error {
        ...
        defer st2.Close()
        if err2 != nil {
                fmt.Println("Prepare error: ", err2)
                return err2
        }
        _, err2 = st2.Query()
